...
class ChaptersSpider(scrapy.Spider):
    ...
    start_urls = ['https://chapters.lk/index.php?route=product/category&path=60_75']
    ...
    def parse(self, response):
        ...
        for i in range(2, 104):
            next_url = "http://chapters.lk/index.php?route=product/category&path=60_75&page=" + str(i)
